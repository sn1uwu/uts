...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2023 at 04:48 AM
...
CREATE TABLE `buku` (
  ...
  `lokasi` enum('Rak1','Rak 2','Rak 3') NOT NULL,
...
(19, 6, '21345667', '2022-03-24', 'Agustus', 2021, 17, 500000);
...
(5, 'admin', 'admin', 'Super Admin', 'admin'),
(6, 'rika', 'rika', 'Rika fitria', 'petugas'),
(7, 'boim', 'boim', 'Boim', 'petugas');
...
INSERT INTO `siswa` (`nisn`, `nis`, `nama`, `id_spp`, `id_kelas`, `alamat`, `no_telp`) VALUES
('123456', '123', 'rivaldi', 17, 8, 'afafd', '12451556'),
('1241413', '12314', 'salya', 17, 8, 'safaadsfaadfafdagagf', '1431513411213'),
('21345667', '12345', 'rivaldi wp', 17, 7, 'jl. bandar raya', '0852666666'),
('3423', '23423423', 'sani', 0, 8, 'usdhf', '5645645');
